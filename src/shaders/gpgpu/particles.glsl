...
uniform float uFlowFieldHeight;
...
void main() {
    ...
    if (particle.a >= 1.0) {
        ...
        // Calculate how much of the flow field to apply based on Y position
        float heightFactor = smoothstep(uFlowFieldHeight, uFlowFieldHeight + 1.0, particle.y);
        ...
        particle.xyz += flowField * uDeltaTime * uFlowFieldStrength * strength * heightFactor;
